                    ...
                    <section className="mx-auto flex max-w-7xl flex-col items-center gap-8 px-6 py-16 text-center md:py-24">
                        ...
                        <Reveal delay={0.2}>
                            <p className="mx-auto max-w-3xl text-lg leading-relaxed text-tb-on-surface-variant">
                                Bergabunglah dengan ribuan keluarga Batak di
                                berbagai organisasi marga dan komunitas
                                regional. Bersama kita jaga warisan leluhur dan
                        ...
                        <Reveal delay={0.3}>
                            <div className="mt-8 flex flex-wrap justify-center gap-4">
                                ...
                                >
                                    <MessageCircle className="h-4 w-4" /> Cara
                                    Bergabung
                                </a>
                            </div>
                        </Reveal>
                        ...
                        <Reveal>
                            <div className="mb-10 text-center">
                                ...
                                <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-tb-on-surface-variant">
                                    Berbagai organisasi marga yang aktif di
                                    seluruh Indonesia. Bergabunglah dan jalin
                                    silaturahmi dengan keluarga besar marga
                                    Anda.
                                </p>
                            </div>
                        </Reveal>
                            ...
                            {komunitasOrganisasi.map((org, index) => (
                                <Reveal key={org.name} delay={index * 0.08}>
                                    <div className="flex h-full flex-col rounded-2xl border border-tb-outline-variant bg-tb-surface-bright p-6">
                                        ...
                                        <p className="mt-1 text-sm text-tb-primary">
                                            {org.region}
                                        </p>
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <Reveal>
                                <div className="mb-10 text-center">
                                    ...
                                    <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-tb-on-surface-variant">
                                        Komunitas lintas marga di berbagai kota
                                        dan wilayah Indonesia. Temukan komunitas
                    ...
                    >
                        <Reveal>
                            <div className="mb-10 text-center">
                                ...
                                <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-tb-on-surface-variant">
                                    Ikuti langkah-langkah mudah berikut untuk
                            ...
                            {caraBergabung.map((step, index) => (
                                <Reveal key={step.step} delay={index * 0.08}>
                                    <div className="relative rounded-2xl border border-tb-outline-variant bg-tb-surface-bright p-6">
                                        ...
                                        <div className="mt-4 mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-tb-surface-container text-tb-primary">
                    ...
                    <section className="mx-auto max-w-7xl px-6 py-16">
                        <Reveal>
                            <div className="rounded-3xl border border-tb-outline-variant bg-tb-surface-bright p-8 text-center md:p-12">
                                ...
                                <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-tb-on-surface-variant">
                                    Apakah Anda pengurus organisasi marga atau
                                    komunitas Batak? Daftarkan organisasi Anda
                                    agar lebih mudah ditemukan oleh anggota
                                    baru.
                                </p>
                                <div className="mt-8 flex flex-wrap justify-center gap-4">
                                    <a
