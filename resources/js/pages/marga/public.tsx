...
const daltol = [
    {
        title: 'Hula-hula',
        description:
            'Pihak keluarga istri yang sangat dihormati — pemberi berkat dalam adat.',
        icon: Handshake,
    },
    {
        title: 'Dongan Sabutuha',
        description:
            'Saudara semarga / sekutu — teman seperjuangan dalam suka dan duka.',
        icon: UserRound,
    },
    {
        title: 'Boru',
        description:
            'Pihak anak perempuan / penerima istri — yang senantiasa melayani dan memberi.',
        icon: Users,
    },
];
                ...
                <section className="mx-auto flex max-w-7xl flex-col items-center gap-8 px-6 py-16 text-center md:py-24">
                    <Reveal>
                        ...
                        <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-tb-on-surface-variant">
                            Marga adalah nama keluarga (klan) masyarakat Batak
                            yang diwariskan dari ayah kepada anaknya. Marga
                            menjadi penanda identitas, menentukan hubungan
                            kekerabatan, dan mengatur peran setiap orang dalam
                            adat.
                        </p>
                        <div className="mt-8 flex flex-wrap justify-center gap-4">
                            ...
                            >
                                <Shapes className="h-4 w-4" /> Marga dalam
                                Budaya
                            </a>
                        </div>
                    </Reveal>
                    ...
                    <Reveal>
                        <div className="mb-10 text-center">
                            ...
                            <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-tb-on-surface-variant">
                                Marga diwariskan secara patrilineal (dari ayah).
                                Satu marga dianggap sebagai saudara, sehingga
                                pernikahan antarsemarga tidak dibenarkan. Marga
                                juga menjadi dasar dari filosofi hidup
                        ...
                        <Reveal>
                            <div className="mb-10 text-center">
                                ...
                                <p className="mx-auto mt-3 max-w-xl text-sm text-tb-on-surface-variant">
                                    Marga-marga yang tercatat dalam silsilah
                                    tarombo kami.
                                </p>
                            </div>
                        </Reveal>
