                        ...
                        <div className="mx-auto max-w-4xl text-center">
                            ...
                            <Reveal delay={0.1}>
                                <h1 className="font-display text-4xl leading-tight font-bold md:text-5xl lg:text-6xl">
                                    Melestarikan Warisan Leluhur untuk Generasi
                                    Masa Depan
                                </h1>
                            </Reveal>
                            <Reveal delay={0.2}>
                                <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-tb-on-surface-variant">
                                    Setiap keluarga Batak memiliki cerita yang
                                    patut diceritakan, silsilah yang patut
                                    dijaga, dan tradisi yang patut dilestarikan.
                                    Tarombo Batak adalah rumah digital bagi
                                    warisan itu.
                                </p>
                            </Reveal>
                        </div>
                        ...
                        <div className="mt-8 space-y-6">
                            {tentangStory.paragraphs.map((paragraph, index) => (
                                <Reveal key={index} delay={index * 0.1}>
                                    <p className="text-lg leading-relaxed text-tb-on-surface-variant">
                                        {paragraph}
                                    </p>
                                </Reveal>
                            ))}
                            ...
                            <Reveal>
                                <div className="mb-10 text-center">
                                    ...
                                    <p className="mx-auto mt-3 max-w-xl text-sm text-tb-on-surface-variant">
                                        ...
                                        milestone penting dalam pelestarian
                                        warisan Batak.
                                    </p>
                                </div>
                            </Reveal>
                            ...
                            <Reveal>
                                <div className="mb-10 text-center">
                                    ...
                                    <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-tb-on-surface-variant">
                                        Prinsip-prinsip yang memandu setiap
                                        keputusan dan tindakan kami dalam
                                        melestarikan warisan Batak.
                                    </p>
                                </div>
                            </Reveal>
                        ...
                        <div className="relative mx-auto max-w-4xl px-6 text-center">
                            ...
                            <Reveal delay={0.2}>
                                <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-white/90">
                                    Mari bersama-sama menjaga warisan leluhur
                                    tetap hidup. Mulai dokumentasikan silsilah
                                    keluarga Anda hari ini dan jadilah bagian
                                    dari gerakan pelestarian budaya Batak.
                                </p>
                            </Reveal>
                            <Reveal delay={0.3}>
