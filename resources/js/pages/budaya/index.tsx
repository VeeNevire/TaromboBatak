        ...
        <MotionConfig reducedMotion="user">
            <div className="scroll-smooth bg-tb-surface font-body text-tb-on-surface antialiased">
                ...
                <main>
                    <section className="mx-auto flex max-w-7xl flex-col items-center gap-8 px-6 py-16 text-center md:py-24">
                        ...
                        <Reveal delay={0.2}>
                            <p className="mx-auto max-w-3xl text-lg leading-relaxed text-tb-on-surface-variant">
                                Budaya Batak kaya akan filosofi, seni, dan
                                tradisi yang diwariskan turun-temurun. Setiap
                                aspek kehidupan masyarakat Batak mencerminkan
                                nilai-nilai luhur leluhur yang tetap relevan
                                hingga kini.
                            </p>
                        </Reveal>
                        <Reveal delay={0.3}>
                            <div className="mt-8 flex flex-wrap justify-center gap-4">
                                ...
                                >
                                    <Palette className="h-4 w-4" /> Jelajahi
                                    Ulos
                                </a>
                            </div>
                        </Reveal>
                        ...
                        <Reveal>
                            <div className="mb-10 text-center">
                                ...
                                <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-tb-on-surface-variant">
                                    Tiga pilar filosofi kehidupan masyarakat
                                    Batak yang mengatur harmoni sosial dalam
                                    setiap aspek kehidupan bermasyarakat dan
                                    upacara adat.
                                </p>
                            </div>
                        </Reveal>
                    ...
                    <section
                        id="ulos"
                        className="bg-tb-surface-bright py-16 md:py-20"
                    >
                        <div className="mx-auto max-w-7xl px-6">
                            <Reveal>
                                <div className="mb-10 text-center">
                                    ...
                                    <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-tb-on-surface-variant">
                                        Kain tradisional Batak dengan motif khas
                                        yang memiliki makna mendalam dalam
                                        setiap upacara adat dan perayaan. Setiap
                                        jenis ulos memiliki fungsi dan
                    ...
                    >
                        <Reveal>
                            <div className="mb-10 text-center">
                                ...
                                <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-tb-on-surface-variant">
                                    Ukiran dan ornamen Batak yang sarat makna
                                    filosofis, menggambarkan kehidupan,
                                    kesuburan, dan perlindungan. Setiap motif
                                    memiliki cerita dan fungsi spiritual.
                                </p>
                            </div>
                        </Reveal>
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <Reveal>
                                <div className="mb-10 text-center">
                                    ...
                                    <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-tb-on-surface-variant">
                                        Rangkaian ritual yang menjaga tradisi
                                        leluhur tetap hidup dari generasi ke
                                        generasi. Setiap upacara memiliki tata
                                        cara dan makna yang telah diwariskan
                                        turun-temurun.
                                    </p>
                                </div>
                            </Reveal>
                    ...
                    <section className="mx-auto max-w-7xl px-6 py-16">
                        <Reveal>
                            <div className="rounded-3xl border border-tb-outline-variant bg-tb-surface-bright p-8 text-center md:p-12">
                                ...
                                <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-tb-on-surface-variant">
                                    Jelajahi cerita-cerita leluhur dan artikel
                                    budaya yang lebih mendalam untuk memahami
