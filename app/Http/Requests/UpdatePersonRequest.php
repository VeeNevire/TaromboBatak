...
class UpdatePersonRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'wives' => ['nullable', 'array'],
            'wives.*.id' => ['nullable', 'exists:people,id'],
            'wives.*.share_code' => ['nullable', 'string', 'max:80'],
            'wives.*.name' => ['nullable', 'string', 'max:255'],
            'wives.*.alias' => ['nullable', 'string', 'max:255'],
            'wives.*.marga_id' => ['nullable', 'exists:margas,id'],
            'wives.*.new_marga' => ['nullable', 'string', 'max:255'],
            'wives.*.birth_year' => ['nullable', 'digits:4'],
            'wives.*.death_year' => ['nullable', 'digits:4'],
            'wives.*.father_name' => ['nullable', 'string', 'max:255'],
